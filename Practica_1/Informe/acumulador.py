...
import acumulador_epy_block_2 as epy_block_2  # embedded python block
import sip
import threading
...
class acumulador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['Vin', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_number_sink_0_2.set_title('RMS')
        ...
        self.blocks_vector_source_x_2 = blocks.vector_source_f((1,1,2,2,0,0), True, 1, [])


        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_vector_source_x_2, 0), (self.epy_block_2, 0))
        self.connect((self.blocks_vector_source_x_2, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.epy_block_2, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.epy_block_2, 1), (self.qtgui_number_sink_0_1, 0))
        self.connect((self.epy_block_2, 2), (self.qtgui_number_sink_0_2, 0))
        self.connect((self.epy_block_2, 3), (self.qtgui_number_sink_0_3, 0))
        self.connect((self.epy_block_2, 4), (self.qtgui_number_sink_0_4, 0))
